    ...
    <div class="buttons">
      <div class="image-upload">
        <label for="file-input">
          <div class="file-clip" :title="$t('chat.upload_file')">
...
export default {
  ...
  methods: {
    send () {
      if (this.$refs.textValue.value !== '') { // A message is to be sent
      ...
      } else if (this.$refs.fileValue.value !== '') { //If a file is to be sent
