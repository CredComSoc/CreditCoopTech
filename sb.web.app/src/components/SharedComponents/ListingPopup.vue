    ...
    <splide :options="options">
      ...
      <div class="textContent">
        ...
        <div class="article-info">
          <h5 v-if="listingObj.status === 'offer'">{{ $t('Offer') }}</h5>
          <h5 v-if="listingObj.status === 'request'">{{ $t('Request') }}</h5>    
          ...
          <div v-if="this.$store.state.user.profile.accountName.toLowerCase() !== listingObj.userUploader.toLowerCase() && listingObj.status === 'offer'" >
            <h5>{{ $t('quantity') }}</h5> 
            <div class="quant">
      ...
      <div class="interactContent" v-if="this.$store.state.user.profile.accountName.toLowerCase() !== listingObj.userUploader.toLowerCase() && listingObj.status === 'offer'">
        <div>
      ...
      <div class="interactContent" v-if="this.$store.state.user.profile.accountName.toLowerCase()!== listingObj.userUploader.toLowerCase() && listingObj.status === 'request'">
        <div>
