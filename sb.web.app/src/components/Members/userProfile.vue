<template>
  <div>
    ...
    <PopupCard v-if="this.tooMuchBkrMsg" @closePopup="this.closePopup" :title="$('user.recipient_balance_too_high')" btnText="Ok" :cardText="$t('user.recipient_balance_too_high_body', {username: profileData.accountName})" />
