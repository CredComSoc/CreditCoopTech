<template>
  <div class="home"> 
    ...
    <ContentCard :title="$t('member')" :description="$t('shop.shopSubtitleforMembers')" theme="yellow-card" theme_btn="yellow-btn" :btn_txt="$t('nav.all_members')" :data="this.members" :screenWidth="scrWidth" name="Members" />
  </div>
</template>
