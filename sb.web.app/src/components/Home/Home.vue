<template>
  <div class="home"> 
    ...
    <ContentCard :title="$t('shop.shop')" :description="$t('shop.shopSubtitle')" theme="blue-card" theme_btn="yellow-btn" :btn_txt="$t('shop.see_the_shop')" :data="this.shop" :screenWidth="scrWidth" name="Shop" />
